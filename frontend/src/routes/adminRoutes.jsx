  ...
  children: [
    {
      ...
      children: [
        ...
        { path: 'institutes', element: <AdminUsers defaultRole="academician" /> },
        { path: 'administrators', element: <AdminUsers defaultRole="admin" /> },
        { path: 'verification', element: <AdminVerification defaultType="company" /> },
        { path: 'verifications', element: <AdminVerification defaultType="company" /> },
        { path: 'industry-verification', element: <AdminVerification defaultType="company" /> },
        { path: 'college-verification', element: <AdminVerification defaultType="college" /> },
