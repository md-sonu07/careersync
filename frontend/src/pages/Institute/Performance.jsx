...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Student Performance" subtitle="Authorized student performance: progress, assessments, skills, streak." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Student Performance</h3>
              <p className="text-sm text-muted">Authorized student performance: progress, assessments, skills, streak.</p>
            </div>
