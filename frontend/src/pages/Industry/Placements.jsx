...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Placements" subtitle="Selected and hired candidates pipeline." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Placements</h3>
              <p className="text-sm text-muted">Selected and hired candidates pipeline.</p>
            </div>
