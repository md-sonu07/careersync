...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Team" subtitle="Manage hiring team members, roles and invites." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Team</h3>
              <p className="text-sm text-muted">Manage hiring team members, roles and invites.</p>
            </div>
