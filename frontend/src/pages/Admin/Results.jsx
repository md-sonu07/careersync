...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Results" subtitle="Assessment results and performance." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Results</h3>
              <p className="text-sm text-muted">Assessment results and performance.</p>
            </div>
