...
export const adminRoutes = {
  ...
  children: [
    ...
    { path: 'internships', element: <Placeholder title="Internships (Admin)" /> },
    { path: 'jobs', element: <Placeholder title="Jobs (Admin)" /> },
    { path: 'applications', element: <Placeholder title="Applications (Admin)" /> },
    { path: 'placements', element: <Placeholder title="Placements (Admin)" /> },
    ...
    { path: 'notifications', element: <Placeholder title="Notifications (Admin)" /> },
