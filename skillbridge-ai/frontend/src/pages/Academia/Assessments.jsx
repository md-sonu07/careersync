...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Assessments" subtitle="Student assessments overview." actions={<Button>Primary Action</Button>} />
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Student assessments overview.</p>
            </div>
