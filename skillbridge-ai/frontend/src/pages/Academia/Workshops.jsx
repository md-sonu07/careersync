...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Workshops" subtitle="Manage workshops and training programs." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Workshops</h3>
              <p className="text-sm text-muted">Manage workshops and training programs.</p>
            </div>
