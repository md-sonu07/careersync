...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Placements" subtitle="Placement funnel and analytics." actions={<Button>Primary Action</Button>} />
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Placement funnel and analytics.</p>
            </div>
