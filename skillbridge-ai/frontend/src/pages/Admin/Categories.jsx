...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Categories" subtitle="Course categories management." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Categories</h3>
              <p className="text-sm text-muted">Course categories management.</p>
            </div>
