...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Certificates" subtitle="Certificate templates and issuance." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Certificates</h3>
              <p className="text-sm text-muted">Certificate templates and issuance.</p>
            </div>
