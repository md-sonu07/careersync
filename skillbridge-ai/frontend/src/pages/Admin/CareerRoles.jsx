...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Career Roles" subtitle="Career roles library: Full Stack, Data Analyst etc." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Career Roles</h3>
              <p className="text-sm text-muted">Career roles library: Full Stack, Data Analyst etc.</p>
            </div>
