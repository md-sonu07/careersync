...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Administrators" subtitle="Manage admin users and roles." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Administrators</h3>
