...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="AI Logs" subtitle="Detailed AI request logs." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">AI Logs</h3>
              <p className="text-sm text-muted">Detailed AI request logs.</p>
            </div>
