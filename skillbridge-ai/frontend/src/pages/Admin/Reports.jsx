...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Reports" subtitle="Platform reports and exports." actions={<Button>Primary Action</Button>} />
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Platform reports and exports.</p>
            </div>
