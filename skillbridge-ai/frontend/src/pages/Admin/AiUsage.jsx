...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="AI Usage" subtitle="AI token usage, requests and cost monitoring." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">AI Usage</h3>
              <p className="text-sm text-muted">AI token usage, requests and cost monitoring.</p>
            </div>
