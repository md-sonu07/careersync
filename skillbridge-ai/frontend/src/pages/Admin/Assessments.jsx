...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Assessments" subtitle="Create and manage assessments." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Assessments</h3>
              <p className="text-sm text-muted">Create and manage assessments.</p>
            </div>
