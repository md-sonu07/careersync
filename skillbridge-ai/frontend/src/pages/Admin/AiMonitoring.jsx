...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Prompt Monitoring" subtitle="Prompt and feature monitoring." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Prompt Monitoring</h3>
              <p className="text-sm text-muted">Prompt and feature monitoring.</p>
            </div>
