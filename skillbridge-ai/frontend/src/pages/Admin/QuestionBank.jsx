...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Question Bank" subtitle="Central question bank with difficulty and skill mapping." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Question Bank</h3>
              <p className="text-sm text-muted">Central question bank with difficulty and skill mapping.</p>
            </div>
