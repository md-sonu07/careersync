...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Documents" subtitle="Verification documents review." actions={<Button>Primary Action</Button>} />
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Verification documents review.</p>
            </div>
