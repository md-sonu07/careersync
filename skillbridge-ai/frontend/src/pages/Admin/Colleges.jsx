...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Colleges" subtitle="College management: add, edit, verify, status and analytics." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Colleges</h3>
              <p className="text-sm text-muted">College management: add, edit, verify, status and analytics.</p>
            </div>
