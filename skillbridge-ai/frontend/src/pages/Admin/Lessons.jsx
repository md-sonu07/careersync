...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Lessons" subtitle="Manage lessons with video and PDF resources." actions={<Button>Primary Action</Button>} />
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Manage lessons with video and PDF resources.</p>
            </div>
