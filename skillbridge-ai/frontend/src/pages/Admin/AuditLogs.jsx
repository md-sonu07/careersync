...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Audit Logs" subtitle="Login, profile updates, course creation and admin actions." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Audit Logs</h3>
              <p className="text-sm text-muted">Login, profile updates, course creation and admin actions.</p>
            </div>
