...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Trending Skills" subtitle="Growing / Stable / Declining skills with demand %" actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Trending Skills</h3>
              <p className="text-sm text-muted">Growing / Stable / Declining skills with demand %</p>
            </div>
