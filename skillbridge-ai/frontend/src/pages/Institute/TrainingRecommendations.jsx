...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Training Recommendations" subtitle="AI recommendations: Why recommended and Expected impact." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Training Recommendations</h3>
              <p className="text-sm text-muted">AI recommendations: Why recommended and Expected impact.</p>
            </div>
