...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Training Programs" subtitle="Training programs catalog and progress." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Training Programs</h3>
              <p className="text-sm text-muted">Training programs catalog and progress.</p>
            </div>
