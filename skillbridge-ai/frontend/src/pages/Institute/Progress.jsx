...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Learning Progress" subtitle="Student learning progress tracking." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Learning Progress</h3>
              <p className="text-sm text-muted">Student learning progress tracking.</p>
            </div>
