...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Skill Distribution" subtitle="Distribution of skills across batches and departments." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Skill Distribution</h3>
              <p className="text-sm text-muted">Distribution of skills across batches and departments.</p>
            </div>
