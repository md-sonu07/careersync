...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Company Detail" subtitle="Company overview, open internships and jobs." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Company Detail</h3>
              <p className="text-sm text-muted">Company overview, open internships and jobs.</p>
            </div>
