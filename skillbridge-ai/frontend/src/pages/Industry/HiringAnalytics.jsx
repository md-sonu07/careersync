...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Hiring Analytics" subtitle="Applications trend, match quality, conversion, shortlist rate and time to hire." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Hiring Analytics</h3>
              <p className="text-sm text-muted">Applications trend, match quality, conversion, shortlist rate and time to hire.</p>
            </div>
