...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Interviews" subtitle="Schedule and manage interviews with date, time, interviewer and evaluation." actions={<Button>Primary Action</Button>} />
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted">Schedule and manage interviews with date, time, interviewer and evaluation.</p>
            </div>
