...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Verification" subtitle="Verification status: Pending / Under Review / Verified / Rejected with documents and reviewer." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Verification</h3>
              <p className="text-sm text-muted">Verification status: Pending / Under Review / Verified / Rejected with documents and reviewer.</p>
            </div>
