...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Skill Requirements" subtitle="Define required and preferred skills with weight and matching logic." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Skill Requirements</h3>
              <p className="text-sm text-muted">Define required and preferred skills with weight and matching logic.</p>
            </div>
