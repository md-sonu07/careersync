...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Candidate Matching" subtitle="AI-powered candidate matching intelligence." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Candidate Matching</h3>
              <p className="text-sm text-muted">AI-powered candidate matching intelligence.</p>
            </div>
