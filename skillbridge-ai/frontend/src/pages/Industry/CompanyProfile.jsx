...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Company Profile" subtitle="Manage logo, about, website, industry, size, locations, benefits, contact and verification status." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Company Profile</h3>
              <p className="text-sm text-muted">Manage logo, about, website, industry, size, locations, benefits, contact and verification status.</p>
            </div>
