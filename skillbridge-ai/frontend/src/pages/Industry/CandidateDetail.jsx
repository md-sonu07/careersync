...
const View = () => {
  return (
    <div className="space-y-6">
      <PageHeader title="Candidate Detail" subtitle="Candidate full profile: summary, skills, assessments, projects, resume and why they match." actions={<Button>Primary Action</Button>} />
      <div className="grid gap-6">
        <Card>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-charcoal">Candidate Detail</h3>
              <p className="text-sm text-muted">Candidate full profile: summary, skills, assessments, projects, resume and why they match.</p>
            </div>
