          ...
          {notifOpen && (
            <div className="absolute right-0 mt-2 w-80 overflow-hidden rounded-2xl border border-border bg-white shadow-card">
              ...
              <div className="divide-y divide-border">
                <div className="flex gap-3 p-3 hover:bg-background"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-primary shrink-0"><AppIcon name="person_search" className="text-[18px]" /></span><div><p className="text-sm font-medium text-charcoal">3 new matching candidates</p><p className="text-xs text-muted">React • 10m ago</p></div></div>
                <div className="flex gap-3 p-3 hover:bg-background"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-success/10 text-success shrink-0"><AppIcon name="assignment" className="text-[18px]" /></span><div><p className="text-sm font-medium text-charcoal">12 new applications</p><p className="text-xs text-muted">Frontend Intern • 1h ago</p></div></div>
              </div>
