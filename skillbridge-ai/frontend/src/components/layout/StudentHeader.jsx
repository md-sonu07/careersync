          ...
          {notifOpen && (
            <div className="absolute right-0 mt-2 w-80 overflow-hidden rounded-2xl border border-border bg-white shadow-card">
              ...
              <div className="divide-y divide-border">
                <div className="flex gap-3 p-3 hover:bg-background"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-primary shrink-0"><span className="material-symbols-outlined text-[18px]">verified</span></span><div><p className="text-sm font-medium text-charcoal">Welcome to CareerSync</p><p className="text-xs text-muted">Complete your profile to get started</p></div></div>
              </div>
